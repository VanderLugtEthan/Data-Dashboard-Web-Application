...
"End) \n" +
    ...
    */
    ...
    app.get('/api/WOBOM/:ParmWO', (req, res) => {
        ...
        var query = `SELECT WALITM AS KItem, P.IMDSC1 as KDesc1, P.IMDSC2 As KDesc2, WAUORG / 1000 as WOQTY, WMCPNB / 100 AS Sequence, WMCPIT as ItemShort, WMCPIL AS ItemLong, B.IMDSC1, B.IMDSC2, WMUORG / 1000 AS Quantity, SUM(LIPQOH/1000) AS OH 
            FROM PRODDTA.F3111 
            ...
            JOIN PRODDTA.F41021 ON LIITM = B.IMITM AND LIMCU = WAMCU 
                    WHERE  WMDOCO = ${ParmWO}  
            GROUP BY WALITM, P.IMDSC1, P.IMDSC2, WAUORG, WMCPNB, WMCPIT, WMCPIL, B.IMDSC1, B.IMDSC2, WMUORG  
            ORDER BY WMCPNB`
